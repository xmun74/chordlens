        ...
        {hasLyrics && (
          <>
            <div className="flex min-h-[68px] min-w-0 items-center gap-3 px-4 pt-5 pb-4 sm:px-6">
              ...
              {currentLyric && (
                <span className="font-mono text-sm text-text-secondary/90 shrink-0 tabular-nums">
                  {currentLyric.time}
                </span>
              )}
            </div>
          ...
          <div className="flex h-auto w-full shrink-0 flex-col border-b border-white/5 lg:h-[180px] lg:w-[200px] lg:border-r lg:border-b-0">
            ...
            <div className="flex items-center gap-3 border-t border-white/5 px-3 py-2">
              ...
              <div className="flex flex-col flex-1 gap-1 min-w-0">
                ...
                {/* 시간 */}
                <span className="font-mono text-xs text-text-secondary/70 tabular-nums">
              ...
              <div className="relative h-full" style={{ width: `${totalWidth}px` }}>
                ...
                {ticks.map((t) => (
                  ...
                  >
                    ...
                    <span className="font-mono text-sm text-text-secondary/70 mt-0.5 tabular-nums">
