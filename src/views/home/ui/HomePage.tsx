      ...
      <section className="mx-auto max-w-7xl px-8 pt-12 pb-10">
        <div className="flex flex-col lg:flex-row gap-12 items-start">
          ...
          <div className="flex-1 max-w-2xl">
            <h1 className="font-[family-name:var(--font-space-grotesk)] text-5xl lg:text-[60px] font-bold leading-[1.2] tracking-[-0.025em] text-text-primary mb-6">
              Learn guitar chords from{" "}
              <span className="bg-gradient-to-r from-accent-light to-accent bg-clip-text text-transparent">
                any YouTube video.
              </span>
            </h1>
            <p className="font-[family-name:var(--font-inter)] text-lg text-text-secondary leading-relaxed mb-8 max-w-xl">
          ...
          <div className="hidden lg:block relative w-[480px] shrink-0">
            <div className="relative rounded-2xl border border-border/10 bg-bg-card/40 overflow-hidden aspect-square backdrop-blur-sm">
              {/* Gradient overlay */}
              <div className="absolute inset-0 bg-gradient-to-br from-transparent to-bg-base/80 z-10" />

              {/* Status badge */}
              <div className="absolute bottom-6 left-6 z-20 flex items-center gap-3">
                <div className="flex h-12 w-12 items-center justify-center rounded-lg bg-gradient-to-br from-accent-light to-accent">
                ...
                <div>
                  <p className="font-[family-name:var(--font-space-mono)] text-sm text-accent-light">
                    STATUS: READY
                  </p>
                  <p className="font-[family-name:var(--font-space-grotesk)] text-lg font-bold text-text-primary">
      ...
      {mutation.isError && (
        <section className="mx-auto max-w-7xl px-8 pb-8">
          <div className="rounded-2xl bg-red-900/20 border border-red-500/20 px-8 py-6 flex items-center justify-between">
            <div>
              <p className="font-[family-name:var(--font-space-grotesk)] font-bold text-red-300">
                분석 실패
              </p>
              <p className="font-[family-name:var(--font-inter)] text-sm text-red-400 mt-1">
                {mutation.error?.message ?? "알 수 없는 오류가 발생했습니다."}
              </p>
            </div>
            <button
              onClick={() => mutation.reset()}
              className="font-[family-name:var(--font-inter)] text-sm font-semibold text-red-300 hover:text-red-200 underline"
            >
              다시 시도
            </button>
          </div>
